...
$consulta_tutores = "
    SELECT t.id_tutor, t.nombre, t.ap_pat, t.ap_mat, t.num_telefono
    FROM tutores t"; // Asumimos que la tabla 'tutores' contiene los campos mencionados
$resultado = [];

$stmt = $pdo->prepare($consulta_tutores);
$stmt->execute();
...
<body>
    ...
    <div class="container content-section">
        <h1 class="section-title">Lista de Tutores</h1>

        <!-- Tabla con todos los tutores -->
        <?php
        if (count($resultado) > 0) {
            ...
            foreach ($resultado as $row) {
                echo "<tr>
                        ...
                        <td>
                            <a href='../editar/editar_tutor.php?id=" . $row['id_tutor'] . "' class='btn btn-success'>Editar</a>
                            <a href='../borrar/borrar_tutor.php?id=" . $row['id_tutor'] . "' class='btn btn-danger'>Borrar</a>
                        </td>
                      </tr>";
            }
            echo "</tbody>
            ...
            echo "<p>No se encontraron tutores.</p>";
        }
        ?>
