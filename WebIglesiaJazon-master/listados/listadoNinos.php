...
// Consulta para obtener los niños del grupo seleccionado y que tienen estado en 1
$consulta_niños = "SELECT id, nombre, apellido_paterno, apellido_materno, edad FROM ninos WHERE grupo_id = :grupo_id AND estado = 1";
$resultado = [];
...
<body>
    ...
    <div class="container content-section">
        ...
        <form method="POST" action="listadoNinos.php">
            ...
            <select name="grupo_id" id="grupo_id" required class="form-select" style="background-color: #fffcd1f6; color: #efb810; border: 1px solid #efb810;">
        ...
        if ($grupo_seleccionado && count($resultado) > 0) {
            ...
            foreach ($resultado as $row) {
                echo "<tr>
                        ...
                        <td>" . $row['edad'] . "</td>
                        <td>
                            <a href='../editar/editar_nino.php?id=" . $row['id'] . "' class='btn btn-success'>Editar</a>
                            <a href='../borrar/borrar_nino.php?id=" . $row['id'] . "' class='btn btn-danger'>Borrar</a>
                        </td>
                      </tr>";
            }
            echo "</tbody>
