...
<head>
    ...
    <style>
        ...
        th {
            background-color: #000;
            /* Color negro para el encabezado */
            color: #efb810;
            /* Texto dorado en el encabezado */
        }

        tr {
            background-color: black;
            /* Color uniforme para todas las filas */
        }

        /* Pie de página */
        footer {
            background-color: #0a0a0a;
            /* Color negro para el pie de página */
            color: #bdc3c7;
            /* Color claro para el texto del pie */
            padding: 1.5rem 0;
            text-align: center;
        }
        ...
        footer a {
            color: #efb810;
            /* Color dorado para enlaces del pie */
        ...
        .selected {
            ...
            /* Color gris oscuro para seleccionado */
        }
    </style>
</head>
    ...
    <div class="container content-section">
        ...
        <form method="POST" action="">
            ...
            <select name="grupo_id" id="grupo_id" required class="form-select"
                style="background-color: #121212; color: #efb810; border: 1px solid #efb810;">
