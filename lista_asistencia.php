...
h1 {
    text-align: center;
    margin-bottom: 20px;
    color: #efb810; /* Título dorado */
    border-bottom: 2px solid #efb810; /* Subrayado dorado */
    padding-bottom: 10px;
}
...
th, td {
    padding: 10px;
    text-align: left;
    border: 1px solid #efb810; /* Bordes dorados */
    color: #efb810;
}
...
.filter-container select {
    ...
    color: #efb810; /* Texto dorado */
    border: 1px solid #efb810; /* Borde dorado */
    margin-top: 10px;
}
        ...
        <table>
            ...
            <tbody>
                ...
                if (isset($_GET['fecha']) && $_GET['fecha'] != "") {
                    ...
                    $sql .= " WHERE a.fecha = '$fecha_seleccionada'";
                }
