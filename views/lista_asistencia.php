                ...
                if (!empty($asistencia)) {
                    ...
                    foreach ($asistencia as $row) {
                        echo "<tr>
                                ...
                                <td>
                                    <a href='editar_asistencia.php?id=" . htmlspecialchars($row["id"]) . "' class='btn btn-edit'>Editar</a>
                                    <a href='borrar_asistencia.php?id=" . htmlspecialchars($row["id"]) . "' class='btn btn-delete'>Borrar</a>
                                </td>
                              </tr>";
                    }
                } else {
