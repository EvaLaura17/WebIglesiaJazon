...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sqlSupervisor = "SELECT * FROM supervisores WHERE usuario = $usuario AND contrasena = $contrasena";
        $stmtSupervisor = $conn->query($sqlSupervisor);

        // Verificar si el usuario existe en la tabla 'maestro'
        $sqlMaestro = "SELECT * FROM maestros WHERE usuario = $usuario AND contrasena = $contrasena";
