...
try {
    ...
    $sql_fechas = "SELECT DISTINCT fecha FROM asistencias";
...
<body>
    ...
    <br>
    <div class="container">
    <h1 lass="section-title">Lista de Asistencia</h1>
    </div>
                    ...
                    if (!empty($asistencia)) {
                        ...
                        foreach ($asistencia as $row) {
                            echo "<tr>
                                ...
                                <td>
                                    <a href='editar/editar_asistencia.php?id=" . htmlspecialchars($row["id"]) . "' class='btn1 btn-edit'>Editar</a>
                                    <a href='borrar/borrar_asistencia.php?id=" . htmlspecialchars($row["id"]) . "' class='btn1 btn-delete'>Borrar</a>
                                </td>
                              </tr>";
                        }
                    } else {
